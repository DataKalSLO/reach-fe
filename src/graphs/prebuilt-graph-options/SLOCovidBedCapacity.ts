const categories = [
  ...
  const data = [
    [99, 6, 145, 6, 86, 59, 6, 65, 265, 1010, 11, 9, 78, 6, 8, 20, 39, 162, 6, 6, 6, 6, 162, 23, 6, 11, 22, 14, 6, 103, 6,6, 18, 10, 94, 99]
  ];
  ...
  export const HealthCareFacityBedOptions: Highcharts.Options = {
    ...
    title: {
      text: ' Licensed and Certified Healthcare Facility Bed Types and Counts in SLO County'
    },
    subtitle:{
