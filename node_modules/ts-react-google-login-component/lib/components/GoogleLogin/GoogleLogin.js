...
var GoogleLoginButton = /** @class */ (function (_super) {
    ...
    GoogleLoginButton.prototype.render = function () {
        var _a = this.props, classNames = _a.classNames, buttonText = _a.buttonText, children = _a.children;
        return (react_1.default.createElement("div", { id: 'ts-google-react-login', className: "" + (classNames ? classNames : ''), onClick: this.clickHandler },
